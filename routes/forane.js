...
router.get("/:foraneid/registration-numbers", getForaneRegistrationNumbers);
router.get('/:foraneid/group-registration-numbers', getForaneGroupRegistrationNumber);
router.put("/:foraneid/registration-numbers", updateForaneRegistrationNumbers);
router.put("/:foraneid/group-registration-numbers", updateForaneGroupRegistrationNumber);
